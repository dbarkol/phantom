...
namespace PhantomFuncApp
{
    public static class Trent900
    {
        ...
        public static async Task Run([EventGridTrigger]EventGridEvent eventGridEvent, TraceWriter log)
        {
            ...
            {
                EngineType = Constants.EngineTypes.Trent900,       // The engine type
            ...
            var subject = Constants.EngineTypes.Trent900;
